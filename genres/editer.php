...
<?php
    try
    {
        ...
        $reponse = $bdd->query('SELECT * FROM genres WHERE id = '.$id_genre);
    }
    catch(Exception $e)
    {
...
<form name="info_acteur" action="modifinfogenre_post.php" method="POST">
<?php while ($donnees = $reponse->fetch()):?>
<input type="hidden" name="id" value="<?php echo $donnees['id']?>" />
<div class="form-group">
<label for="label">label</label>
<input type="text" class="form-control" name="label" aria-describedby="label" placeholder="<?php echo $donnees['label']?>" required>
</div>
<?php endwhile;?>
