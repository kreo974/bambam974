...
<form name="info_acteur" action="ajoutergenre_post.php" method="POST">
<div class="form-group">
<label for="label">Genre</label>
<input type="text" class="form-control" name="label" aria-describedby="label" placeholder="label" required>
</div>
